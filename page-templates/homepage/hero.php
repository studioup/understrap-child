  ...
  <div class="layout__col2 container">
    ...
    <div class="hero__height2">
      <div class="row no-gutters">
        ...
        <div class="col-sm-8 border-left-white border-right-white">
          <div class="hero__main-content background-dotted-white">
            <div class="hero__headlines">
              <h1>Converting your power</h1>
              <h3>We are committed to innovate</h3>
            </div>
          </div>
        </div>
        <div class="col-sm-2"></div>
